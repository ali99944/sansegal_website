...
export default function AboutPage({ dictionary }: TranslatedViewProps) {
  ...
  return (
    <div className="bg-neutral-light pb-12">
      ...
      {/* Values */}
      <section className="section-padding bg-neutral-light py-12 max-w-7xl mx-auto ">
        <div className="container-luxury">
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
            {values.map((value, index) => (
              <Card key={index} className="text-center group bg-white p-6 rounded-lg transition-shadow duration-300">
                <div className="inline-flex items-center justify-center w-16 h-16 bg-black rounded-full mb-6 group-hover:bg-secondary transition-all duration-300">
                  <value.icon className="h-8 w-8 text-white group-hover:text-gray-800" />
                </div>
